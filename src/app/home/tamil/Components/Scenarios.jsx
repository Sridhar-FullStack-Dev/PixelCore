...
import { scenariosDivTamil } from "@/app/Utils";
...
export default function Scenarios() {
  return (
    <motion.div
      ...
      className="rounded-[20px] h-auto p-8 w-full bg-white -z-10"
    >
      <motion.div
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ type: "anticipate", duration: 1, delay: 1 }}
        className="font-roboto text-gray-400 text-xl font-bold"
      >
        காட்சிகள்
      </motion.div>
      ...
      <div className="flex sm:flex-col lg:flex-row">
        ...
        <div>
          <div>
            ...
            <div className="flex items-center sm:pt-4 lg:pt-10">
              ...
              >
                <Link href={"/"}>மேலும் வாசிக்க.</Link>
              </motion.div>
            </div>

            <div className="font-body font-bold sm:text-3xl lg:text-6xl xl:text-7xl sm:pt-8 lg:pt-28">
              வியாபார வளர்ச்சிக்
              <Image
                src="/3d-fire.png"
                height={300}
        ...
        <div className="flex flex-col justify-end items-end w-full gap-8 sm:mt-4 lg:mt-0">
          {scenariosDivTamil.map((scene, key) => (
            <motion.div
            ...
            >
              ...
              />
              <h1 className="font-roboto sm:text-[0.8rem] lg:text-xl xl:text-2xl font-bold whitespace-nowrap">
          ...
          >
            ...
            <h1 className="font-roboto sm:text-[0.8rem] lg:text-xl xl:text-2xl font-bold text-white whitespace-nowrap">
              கலாச்சாரம் மற்றும் நிகழ்வுகள் <sup>1</sup>
            </h1>
            <div className="sm:hidden lg:flex h-20 w-20 rounded-full bg-white flex items-center justify-center">
              <HiArrowSmallDown className="text-3xl" />
            </div>
          ...
          >
            <Image
              ...
              style={{ objectFit: "cover" }}
            />
            <h1 className="font-roboto sm:text-base lg:text-xl xl:text-2xl font-bold whitespace-nowrap">
              இன்டர்ன்ஷிப்கள் <sup>1</sup>
            </h1>
            <div className="sm:hidden lg:flex h-20 w-20 rounded-full bg-white flex items-center justify-center">
              <HiArrowSmallDown className="text-3xl" />
            </div>
