    ...
    <>
      <div className="sm:h-screen lg:h-[80vh] xl:h-screen bg-black relative">
        <div className="p-2 text-white bg-white bg-opacity-5">
          ...
          >
            {footerMarqueeTamil.map((marquee, key) => (
              <div
                key={key}
        ...
        <div className="text-[#6e6d7a] px-6 py-4 font-body absolute bottom-0 w-full">
          ...
          <div className="flex sm:flex-col md:flex-row justify-between items-center">
            <div className="flex gap-4 items-center justify-center whitespace-nowrap sm:text-[14px] md:text-[11px] lg:text-[14px] xl:text-base">
              <Link href={"/"} className="">
                <motion.h1
              ...
              {footerBottom1Tamil.map((bottom1, footerbottom1Tamil) => (
                <Link key={footerbottom1Tamil} href={bottom1.href}>
                  <motion.h1
                    whileHover={{ color: "#cef34a" }}
                    transition={{ ease: "linear" }}
                  >
              ...
              <motion.div
                whileHover={{ color: "#cef34a" }}
                className="cursor-default sm:text-[14px] md:text-[11px] lg:text-[14px]"
              >
            ...
            <div className="flex sm:gap-2 md:gap-4 sm:text-[9px] md:text-[11px] lg:text-[14px] xl:text-base items-center justify-center sm:px-2 md:px-0">
              {footerBottom2Tamil.map((bottom2, footerbottom2) => (
